...
} elseif ($_instance->childHasBeenRendered('LdS7DNk')) {
    $componentId = $_instance->getRenderedChildComponentId('LdS7DNk');
    $componentTag = $_instance->getRenderedChildComponentTagName('LdS7DNk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LdS7DNk');
} else {
    $response = \Livewire\Livewire::mount('items.show-item');
    $html = $response->html();
    $_instance->logRenderedChild('LdS7DNk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
