...
} elseif ($_instance->childHasBeenRendered('zSZ5afZ')) {
    $componentId = $_instance->getRenderedChildComponentId('zSZ5afZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('zSZ5afZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zSZ5afZ');
} else {
    $response = \Livewire\Livewire::mount('post.post');
    $html = $response->html();
    $_instance->logRenderedChild('zSZ5afZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
