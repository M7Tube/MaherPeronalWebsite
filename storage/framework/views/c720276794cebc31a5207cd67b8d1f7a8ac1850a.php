            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto"
                            href="<?php echo e(route('showAllServices', app()->getLocale())); ?>"><?php echo e(__('Services')); ?></a></li>
                    <li><a class="nav-link scrollto"
                            href="<?php echo e(route('showAllItems', app()->getLocale())); ?>"><?php echo e(__('Items')); ?></a></li>
                    <li><a class="nav-link scrollto"
                            href="<?php echo e(route('showAllPosts', app()->getLocale())); ?>"><?php echo e(__('Blog')); ?></a></li>
