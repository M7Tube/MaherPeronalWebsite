...
} elseif ($_instance->childHasBeenRendered('65A5Yck')) {
    $componentId = $_instance->getRenderedChildComponentId('65A5Yck');
    $componentTag = $_instance->getRenderedChildComponentTagName('65A5Yck');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('65A5Yck');
} else {
    $response = \Livewire\Livewire::mount('items.items');
    $html = $response->html();
    $_instance->logRenderedChild('65A5Yck', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
