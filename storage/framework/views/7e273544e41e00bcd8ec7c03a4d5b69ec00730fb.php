...
} elseif ($_instance->childHasBeenRendered('GES6dFs')) {
    $componentId = $_instance->getRenderedChildComponentId('GES6dFs');
    $componentTag = $_instance->getRenderedChildComponentTagName('GES6dFs');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GES6dFs');
} else {
    $response = \Livewire\Livewire::mount('items.items');
    $html = $response->html();
    $_instance->logRenderedChild('GES6dFs', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
