...
} elseif ($_instance->childHasBeenRendered('yQfatCl')) {
    $componentId = $_instance->getRenderedChildComponentId('yQfatCl');
    $componentTag = $_instance->getRenderedChildComponentTagName('yQfatCl');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yQfatCl');
} else {
    $response = \Livewire\Livewire::mount('services.services');
    $html = $response->html();
    $_instance->logRenderedChild('yQfatCl', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
