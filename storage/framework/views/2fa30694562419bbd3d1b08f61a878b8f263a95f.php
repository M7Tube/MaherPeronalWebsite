...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <h1 class="logo"><a href="<?php echo e(route('homepage')); ?>"><?php echo e(__('Maher Shehadie')); ?></a></h1>
        ...
        <div class="hero-content display-table">
            <div class="table-cell">
                <div class="container">
                    ...
                    <h1 class="hero-title mb-4"><?php echo e(__('I Am Maher Shehadie')); ?></h1>
                    <p class="hero-subtitle"><span class="typed"
                            data-typed-items="<?php echo e(__('Online Marketing')); ?>, test, test"></span></p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-7">
                                            <div class="about-info">
                                                <p><span class="title-s">Name: </span> <span>Morgan
                                                        Freeman</span></p>
                                                ...
                                                <p><span class="title-s">Phone: </span> <span>(617)
                                                        557-0089</span></p>
                                            </div>
                                        </div>
                                    </div>
...
<?php /**PATH C:\Users\Abo Samer\Desktop\Work\Maher Project\laravel project\MaherPeronalWebsite\resources\views/welcome.blade.php ENDPATH**/ ?>