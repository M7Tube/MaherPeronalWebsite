...
} elseif ($_instance->childHasBeenRendered('CJihcOy')) {
    $componentId = $_instance->getRenderedChildComponentId('CJihcOy');
    $componentTag = $_instance->getRenderedChildComponentTagName('CJihcOy');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('CJihcOy');
} else {
    $response = \Livewire\Livewire::mount('dashboard.services.create-service');
    $html = $response->html();
    $_instance->logRenderedChild('CJihcOy', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
